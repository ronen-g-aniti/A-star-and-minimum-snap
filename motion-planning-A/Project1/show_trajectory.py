...
path_df = pd.read_csv('path_output.csv')
trajectory_df = pd.read_csv('trajectory_output.csv')
...
if not trajectory_df.empty:
    ax.plot(trajectory_df['x'], trajectory_df['y'], trajectory_df['z'], c='m', linewidth=2, label='Trajectory')

# Set labels and title
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_zlabel('Z')
ax.set_title('3D Path and Trajectory Visualization')
